 ...
 if($peticion_consultar_albumes == null){
  echo '<script>
  alert("Primero debes de crear un albúm");
 ...
 <div  id="formulario-blog">
 	...
 	<form action="../../controller/enrutador/route.php" method="post" class="formulario">
       ...
       Formulario de creación de elementos para la galeria
     </div>
     <div class="form-control" style="display: none;">

      <input type="hidden" id="tipo_peticion" value="15"   class="input-form" name="tipo_peticion">
    ...
    <div class="form-control">
      ...
      <br>
      <br>
      <input type="text" class="input-form" id="titulo_programa"  name="contenido_galeria_nombre" placeholder="Nombre del elemento" required >
    ...
    <div class="form-control">
      ...
      <br>
      <br> 
     <select name="album_id" class="input-form" id="" required>
...
echo '<option value="'.$album['album_id'].'">'.$album['album_titulo'].'</option>';
    ...
    <div class="form-control">
      ...
      <br>
      <br>
      <input type="text" id="btn-abrir-multimedia" name="contenido_galeria_foto" placeholder="Seleccionar archivo multimedia"   required  class="input-form"  style="background-color: gray; color: white; font-weight: 900; cursor: pointer" >
 ...
 <center><input type="submit" id="btn-activar-formulario" value="Crear Elemento" style="display:block;"></center> 
</form>
</div>
<div class="respuesta">
