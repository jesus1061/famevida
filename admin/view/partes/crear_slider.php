 ...
 <div  id="formulario-blog">
     ...
     <div class="form-control" style="display: none;">
      ...
      <input type="hidden" id="tipo_peticion" value="13"   class="input-form" name="tipo_peticion">
    ...
    <div class="form-control">
      ...
      <br>
      <br>
      <input type="text" class="input-form" id="titulo_programa"  name="banner_nombre" placeholder="Titulo del banner" required maxlength="19" >
    ...
    <div class="form-control">
      ...
      <br>
      <br>
      <input type="text" id="btn-abrir-multimedia" name="banner_imagen"  placeholder="Seleccionar archivo multimedia"   required  class="input-form"  style="background-color: gray; color: white; font-weight: 900; cursor: pointer" >
 ...
 <center><input type="submit" id="btn-activar-formulario" value="Crear Banner" style="display:block;"></center> 
</form>
</div>
