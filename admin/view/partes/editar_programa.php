...
$peticion_programa = $instancia -> consultar_programa_unico_controller($programa_id);
        ...
        <div  id="formulario-blog">
          ...
          <form action="../../controller/enrutador/route.php" method="post" class="formulario">
            <div class="encabezado-formulario">
              Formulario de edición de programas
            </div>
            <div class="form-control" style="display: none;">

              <input type="hidden" id="tipo_peticion" value="25"   class="input-form" name="tipo_peticion">
            ...
            <div class="form-control">
              ...
              <br>
              <br>
              <input type="text" class="input-form" id="titulo_programa"  name="titulo_programa" value="<?php echo $programa['titulo_programa'];?>" required >
              <input type="hidden" class="input-form" id="titulo_programa"  name="programa_id" value="<?php echo $programa['programa_id'];?>" required >
            ...
            <div class="form-control">
              ...
              <br>
              <br>
              <input type="text" name="contenido_programa"  class="input-form" style="height: 100px" value="<?php echo $programa['contenido_programa'];?>">
            ...
            <div class="form-control">
              ...
              <br>
              <br>
              <input type="text" id="btn-abrir-multimedia" name="portada_programa" value='<?php echo $programa['portada_programa'];?>'  required  class="input-form" readonly style="background-color: gray; color: white; font-weight: 900; cursor: pointer" >
            ...
            <center><input type="submit" id="btn-activar-formulario" value="Editar programa" style="display:block;"></center> 
          </form>
        </div>
        <div class="respuesta">
