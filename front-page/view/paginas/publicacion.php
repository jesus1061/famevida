...
$peticion_blog = $instancia -> listar_blog_unico_controller_front_page($publicacion);
...
<head>
	...
	<style>
		.container-programa{background-color: rgba(225,225,225,0.90)}
		@media only screen and (max-width: 600px) {	body{background-image: url("images/banner3.jpg"); background-size: cover;}
		.container-programa{width: 100%;  margin: auto; padding-top: 20px; padding-bottom: 20px; }
		...
		@media only screen and (min-width: 600px) {	body{background-image: url("images/banner3.jpg"); background-size: cover;}
		.container-programa{width: 87.5%;  margin: auto; padding-top: 20px; padding-bottom: 20px; }
		...
		@media only screen and (min-width: 768px) {	body{background-image: url("images/banner3.jpg"); background-size: cover;}
		.container-programa{width: 87.5%;  margin: auto; padding-top: 20px; padding-bottom: 20px; }
		...
		@media only screen and (min-width: 992px) {	body{background-image: url("images/banner3.jpg"); background-size: cover;}
		.container-programa{width: 87.5%;  margin: auto; padding-top: 20px; padding-bottom: 20px; }
		.contenedor-programa{width: 70%; margin: auto; display: table;}
		.portada{width: 95%; -webkit-box-shadow: -1px 0px 11px 0px rgba(0,0,0,0.75);
			-moz-box-shadow: -1px 0px 11px 0px rgba(0,0,0,0.75);
		...
		@media only screen and (min-width: 1200px) {	body{background-image: url("images/banner3.jpg"); background-size: cover;}
		.container-programa{width: 87.5%;  margin: auto; padding-top: 20px; padding-bottom: 20px; }
		.contenedor-programa{width: 70%; margin: auto; display: table;}
		.portada{width: 95%; -webkit-box-shadow: -1px 0px 11px 0px rgba(0,0,0,0.75);
			-moz-box-shadow: -1px 0px 11px 0px rgba(0,0,0,0.75);
...
<body>
	<div class="container-programa">
		...
		<br>
		<div class="contenedor-volver"><button class="btn-volver" style="background-color: #a43474;"><a href="index.php" style="color:white;">Volver</a></button></div>
